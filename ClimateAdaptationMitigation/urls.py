...
from ClimateAdaptationMitigation.views import FormView, MapView, EdgeView, MapView2
from ClimateAdaptationMitigation.views import legendView
...
urlpatterns = [
    ...
    #url(r'^type', TemplateView.as_view(template_name="ClimateAdaptationMitigation/html/type.html")),
        ...
        url(r'^scope', legendView.as_view(template_name="scope.html")),
        url(r'^type', legendView.as_view(template_name="type.html")),
        url(r'^test/$', legendView.as_view(), name='test'),
        #url(r'^test/$', legendView),
